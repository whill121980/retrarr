#!/bin/zsh
# retrarr.sh — Retro Retriever v0.2.0
...
init_static_globals () {
    typeset -gr RETRARR_VERSION="Retro Retriever v0.2.0"
    ...
    # Paths
    typeset -gr WRK_DIR="/media/fat/Scripts/.config/retrarr"
    ...
    # Watch in second SSH session: tail -f /media/fat/Scripts/.config/retrarr/retrarr.log
    ...
    typeset -gr TG16CD_GAMEDIR_DEFAULT="/media/fat/games/TGFX16-CD"
    ...
    typeset -gr MCD_GAMEDIR_DEFAULT="/media/fat/games/MegaCD"
    ...
    typeset -gr PSXUS_GAMEDIR_DEFAULT="/media/fat/games/PSX"
    ...
    typeset -gr PSXEU_GAMEDIR_DEFAULT="/media/fat/games/PSX"
    ...
    typeset -gr PSXJP_GAMEDIR_DEFAULT="/media/fat/games/PSX"
    ...
    typeset -gr PSXJP2_GAMEDIR_DEFAULT="/media/fat/games/PSX"
    ...
    typeset -gr PSXMISC_GAMEDIR_DEFAULT="/media/fat/games/PSX"
    ...
    typeset -gr AO486_GAMEDIR_DEFAULT="/media/fat"
    ...
    typeset -gr CD32_GAMEDIR_DEFAULT="/media/fat/games/AmigaCD32"
}
...
ao486_setnames_all () {
    ...
    log_info "ao486_setnames_all: ${#mgls} games found, processing"
    print "${#mgls} games found, processing.."
    local mgl
    for mgl in $mgls; do ao486_append_setname $mgl; done
    log_info "ao486_setnames_all: complete"
    print "Done!"
}
...
organise_chd_dir () {
    setopt localoptions extendedglob
    local gamedir="${*%/}"
    [[ -d $gamedir ]] || { log_error "organise_chd_dir: $gamedir is not a directory" ; print "ERROR: $gamedir is not a directory" ; return 1 }
